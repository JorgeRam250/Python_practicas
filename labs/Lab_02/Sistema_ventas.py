...
def main() -> None:
    ...
    # Uso: python Sistema_ventas.py --demo ventas.json
    if len(sys.argv) >= 3 and sys.argv[1] == "--demo":
        ruta = sys.argv[2]

        _print_header("PROBANDO: Sistema de Ventas")
        try:
            reporte = ejecutar(ruta)
            print("\n[OK] Sistema_ventas ejecutado exitosamente")
        ...
        try:
            ...
            print("\n[OK] Sistema_ventas (filtrado) ejecutado exitosamente")
            print("\nSalida del programa:")
    ...
    if len(sys.argv) < 2:
        print("Uso: python Sistema_ventas.py <archivo_json> [categoria]")
        print("Ejemplo: python Sistema_ventas.py ventas.json Electrónicos")
        print("Demo:   python Sistema_ventas.py --demo ventas.json")
        sys.exit(1)
