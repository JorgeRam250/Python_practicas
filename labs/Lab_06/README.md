# 🐍 Laboratorio Python: Librería Estándar y E/S

## 📋 Descripción del Laboratorio

Este laboratorio te enseñará a manejar las herramientas fundamentales de Python para el procesamiento de datos y la automatización de tareas.

## 🎯 Objetivos de Aprendizaje

- ✅ Manipular archivos y rutas de forma segura con `pathlib`
- ✅ Leer y escribir archivos CSV, JSON y YAML
- ✅ Trabajar con fechas, horas y zonas horarias
- ✅ Configurar logging estructurado para tus aplicaciones
...
**¡Felicidades!** 🎉 Has completado el laboratorio de librería estándar de Python.
